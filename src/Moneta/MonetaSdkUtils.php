...
class MonetaSdkUtils
{
	...
	public function requireView($viewName, $data)
	{
        $result = false;
    ...
    {
        // TODO: согласно паттерну, здесь надо только зарегистрировать событие, а диспатч всех событий надо делать в цикле после полного выполнения основного кода
